export const Team: any[] = [
    {
        name: '<h4>Cecilia Bandeira</h4>',
        role: 'TEAM.EXECUTIVE_PRODUCER',
    ...
    {
        name: '<h4>Priscilla Esteves</h4>',
        role: 'TEAM.COMMUNICATION_MAN',
        // tslint:disable-next-line:max-line-length
    ...
    },
    {
        ...
        role: 'TEAM.ARTISTIC_PRODUCER_AND_PROGRAMMER',
        // tslint:disable-next-line:max-line-length
    ...
    },
    {
        ...
        // tslint:disable-next-line:max-line-length
        img: 'https://firebasestorage.googleapis.com/v0/b/delidoku-b2ece.appspot.com/o/team%2Foptimized%2FDiana.png?alt=media&token=5aea63c0-6ce6-4955-a455-ab2a6aca1d7b'
